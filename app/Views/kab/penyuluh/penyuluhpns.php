                    ...
                    <table class="table align-items-center mb-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="align-middle text-center">
                                    <span class="text-secondary text-xs font-weight-bold">3502042108650001</span>
                                </td>
                                <td class="align-middle text-center">
                                    <span class="text-secondary text-xs font-weight-bold">196508211988031012</span>
                                </td>
                                <td class="align-middle text-center">
                                    <span class="text-secondary text-xs font-weight-bold">Agus Ridho Rudhiono SP.</span>
                                </td>
                                <td class="align-middle text-center">
                                    <span class="text-secondary text-xs font-weight-bold">BPP PACITAN</span>
                                </td>
                                <td class="align-middle text-center">
                                    <span class="text-secondary text-xs font-weight-bold">Kec.Pacitan</span>
                                </td>
                                <td class="align-middle">
                                    <span class="text-secondary text-xs font-weight-bold">1.Kayen<br>
                                        2.Sukoharjo<br>
                                        3.Sirnoboyo<br>
                                        4.<br>
                                        5.<br>
                                ...
                                <td class="align-middle text-center">
                                    <span class="text-secondary text-xs font-weight-bold">3D / PP. PENYELIA</span>
                                </td>
                                <td class="align-middle text-center">
                                    <span class="text-secondary text-xs font-weight-bold">6 Januari 2021</span>
                                </td>
