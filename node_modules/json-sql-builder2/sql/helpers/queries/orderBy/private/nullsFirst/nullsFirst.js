...
class nullsFirst extends SQLBuilder.SQLHelper {
	constructor(sql){
		super(sql);
...
module.exports = {
	definition: nullsFirst,
	description: 'Specifies the `NULLS FIRST` option for the `ORDER BY` clause on each column.',
 	supportedBy: {
