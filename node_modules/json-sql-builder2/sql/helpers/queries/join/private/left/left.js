		...
		Object: {
			...
			'Oracle Basic Usage': function(sql) {
				return {
					...
					expectedResults: {
						sql: 'SELECT people.first_name, people.last_name, skills.description, skills.rate FROM people LEFT JOIN (SELECT * FROM people_skills WHERE is_skill = $1) skills ON skills.people_id = people.people_id WHERE skills.rate > $2',
						values:{
							$1: 1,
							$2: 50
						}
